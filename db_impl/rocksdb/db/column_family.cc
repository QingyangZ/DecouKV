...
WriteStallCondition ColumnFamilyData::RecalculateWriteStallConditions(
  ...
  if (current_ != nullptr) {
    ...
    if (write_stall_condition == WriteStallCondition::kStopped &&
      ...
      ms.open("/mnt/sde/zqy/data/rocksdb/flush_stall.txt",std::ios::out|std::ios::app);
      ms << ioptions()->clock->NowMicros()/1000000 << " " << imm()->NumNotFlushed() << std::endl;
      ms.close();
      ...
      ls.open("/mnt/sde/zqy/data/rocksdb/l0l1_stall.txt",std::ios::out|std::ios::app);
      ls << ioptions()->clock->NowMicros()/1000000 << " " << 0 << std::endl;
      ls.close();
    } else if (write_stall_condition == WriteStallCondition::kStopped &&
      ...
      ps.open("/mnt/sde/zqy/data/rocksdb/pending_stall.txt",std::ios::out|std::ios::app);
      ps << ioptions()->clock->NowMicros()/1000000 << " " << 0 << std::endl;
      ps.close();
      ...
      // auto nowmicros = ioptions()->clock->NowMicros()/1000000;
      // ms.open("/mnt/sdc/tht/result_nvm/flush_stall.txt",std::ios::out|std::ios::app);
      // ms << nowmicros << " " << 1 << std::endl;
      // ms.close();
      // ls.open("/mnt/sdc/tht/result_nvm/l0l1_stall.txt",std::ios::out|std::ios::app);
      // ls << nowmicros << " " << 1 << std::endl;
      // ls.close();
      // ps.open("/mnt/sdc/tht/result_nvm/pending_stall.txt",std::ios::out|std::ios::app);
      // ps << nowmicros << " " << 1 << std::endl;
      // ps.close();

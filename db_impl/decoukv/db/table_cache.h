...
class TableCache {
 public:
  ...
  InternalIteratorBase<IndexValue>* IndexBlockGet(
  ...
  // Get a data block iterator by index value
  Status GetIterByIndexBlock(const ReadOptions& options,
                             const InternalKeyComparator& internal_comparator,
                             const FileMetaData& file_meta,
                             const SliceTransform* prefix_extractor,
                             HistogramImpl* file_read_hist, bool skip_filters,
                             int level, size_t max_file_size_for_l0_meta_pin,
                             IndexValue& value, DataBlockIter* iiter);

  Status GetByIndexValue(const ReadOptions& options,
                         const InternalKeyComparator& internal_comparator,

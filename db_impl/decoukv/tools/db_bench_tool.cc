...
// Current the following isn't equivalent to OS_LINUX.
 ...
 private:
  ...
  void InitializeOptionsFromFlags(Options* opts) {
    ...
    uint64_t nvm_size = 1024LL*1024*1024*100;
    options.db_paths.emplace_back(FLAGS_db, ssd_size);
    options.db_paths.emplace_back("/mnt/pmem0/zqy/ycsb/rocksdb/100GB_index",
                                  nvm_size);

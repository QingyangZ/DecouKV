...
InternalIteratorBase<IndexValue>* BlockBasedTable::GetIndexBlockIter(
    const ReadOptions& read_options, const SliceTransform* prefix_extractor,
  ...
  auto iiter = NewIndexIterator(read_options, need_upper_bound_check,
                                iiter_on_stack, nullptr, nullptr);
...
void BlockBasedTable::GetDataBlockIterByIndex(
    const ReadOptions& read_options, IndexValue& value,
    DataBlockIter* biter) {
  NewDataBlockIterator<DataBlockIter>(
      read_options, value.handle, biter, BlockType::kData, nullptr, nullptr,
      /*s=*/Status(), /*prefetch_buffer*/ nullptr);
  return;
}

Status BlockBasedTable::GetByIndexValue(const ReadOptions& read_options,
                                        const Slice& key, IndexValue& value,
                                        GetContext* get_context,
                                        const SliceTransform* prefix_extractor,
                                        bool skip_filters) {

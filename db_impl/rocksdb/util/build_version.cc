...
static const std::string rocksdb_build_git_tag = "rocksdb_build_git_tag:v6.19.3";
...
static const std::string rocksdb_build_date = "rocksdb_build_date:2025-05-15 19:20:49";
#endif

...
struct NvmSetup {
  bool use_nvm_module = true;

  //bool reset_nvm_storage = false;

  std::string pmem_path = "/mnt/pmem0/test";  //目录

  uint64_t Level0_column_compaction_trigger_size = 5ul * 1024 * 1024 * 1024;  //7G trigger
  uint64_t Level0_column_compaction_slowdown_size = 5ul * 1024 * 1024 * 1024 + 512ul * 1024 * 1024;  //7.5G slowdown
  uint64_t Level0_column_compaction_stop_size = 6ul * 1024 * 1024 * 1024;   //8G stop

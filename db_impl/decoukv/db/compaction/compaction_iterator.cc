...
// modified by zqy
void CompactionIterator::ReplaceValue(/*Slice& value, */void* next_node) {
  input_->ReplaceValue(/*value, */next_node);
}

void CompactionIterator::SeekToHead() { input_->SeekToHead(); }

...
class BlockBasedTable : public TableReader {
 public:
  ...
  InternalIteratorBase<IndexValue>* GetIndexBlockIter(
      const ReadOptions& read_options,
      const SliceTransform* prefix_extractor,
      IndexBlockIter* iiter_on_stack) override;

  void GetDataBlockIterByIndex(
      const ReadOptions& read_options, IndexValue& value,
      DataBlockIter* biter) override;

  Status GetByIndexValue(
      const ReadOptions& read_options, const Slice& key, IndexValue& value,
      GetContext* get_context, const SliceTransform* prefix_extractor,

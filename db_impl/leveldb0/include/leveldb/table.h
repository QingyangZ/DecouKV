...
class LEVELDB_EXPORT Table {
 public:
  ...
  Iterator* GetIterByIndex(const ReadOptions& options, Slice& value);
 private:
  ...
  Iterator* IndexGet();
  void DeleteIndexBlock();

  // Return the pointer to iterator over the data block, given the index value.
  // @param value: The index value
  Status GetByIndex(const ReadOptions& options, const Slice& k, Slice& value,
                       void* arg,

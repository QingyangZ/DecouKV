...
class MemTableRep {
 public:
  ...
  // modified by zqy
  virtual void GetByNode(const LookupKey& k, void* callback_args,
                         bool (*callback_func)(void* arg, const char* entry),
                         void** next_node){};

  virtual void Compact(SequenceNumber seq, void* last_table){};
  ...
  class Iterator {
   public:
    ...
    // modified by zqy
    virtual void ReplaceValue(/*Slice& value, */void* next_node){};
    virtual void* GetNode() { return nullptr; };
    virtual void SeekToHead(){};
    virtual bool IsHead() { return false; };
    virtual void SeekByNode(const Slice& internal_key, const char* memtable_key,
                            void** next_node){};
